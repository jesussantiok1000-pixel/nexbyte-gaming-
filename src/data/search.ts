...
export const searchEntries: SearchEntry[] = [
  ...
  ...approvedProducts.map(product=>({title:product.title,description:product.shortDescription,type:"Análisis" as const,url:product.analysisUrl,keywords:[product.category,...product.features,...product.usage].join(" ")})),
